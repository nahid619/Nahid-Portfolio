...
export async function getHomePageData() {
  ...
  // Which tab is selected on first paint. The full skill/project arrays are
  // already loaded above, so the client filters them in memory — no extra
  // query here, and no client-side fetch on tab change.
  ...
  return {
    profile,
    experiences,
    projects,          // ALL projects — client filters by category
    skills,            // ALL skills   — client filters by category
    skillCategories,
    projectCategories,
    certifications,
    qualifications,
